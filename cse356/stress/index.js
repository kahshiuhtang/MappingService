...
export const options = {
    scenarios: {
        constant_load: {
          ...
          rate: 100, // 4000 requests per second
          ...
          maxVUs: 4000, // adjust this based on your desired max concurrency
        },
      },
      http: {
...
export default () => {
    let x = Math.floor(Math.random() * (2046 + 1)) + 1;
    let y = Math.floor(Math.random() * (2046 + 1)) + 1;
    const urlRes = http.get(`http://143.198.19.157/tiles/9/${x}/${y}.png`);
